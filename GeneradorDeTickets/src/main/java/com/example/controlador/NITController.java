...
public class NITController {
    ...
    private void initialize() {
        // Aplicar el formateador para permitir solo caracteres alfanuméricos
    ...
    private void verificarNIT(ActionEvent event) {
        String nitIngresado = NIT.getText().trim(); // Eliminar espacios en blanco al inicio/final
        ...
        // Validación básica: Longitud mínima (varía según país, ejemplo para Guatemala: mínimo 8-9 caracteres)
